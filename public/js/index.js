...
const informationDisplay = document.querySelector(
...
const iconsPlus = document.querySelector('#iconPlus1');
const iconsPlus2 = document.querySelector('#iconPlus2');
...
iconsPlus.addEventListener('click', function(){
  document
    .querySelector('#tag1')
    .classList.toggle('showDetailsPlus');
})

if (iconsPlus2)
iconsPlus2.addEventListener('click', function () {
...
if (linkToSignin)
  linkToSignin.addEventListener('click', function () {
    console.log('hey');
