...
exports.logoutBtn = exports.logout = exports.signup = exports.login = exports.showMyAlertFail = exports.showMyAlert = void 0;
...
var showMyAlert = function showMyAlert() {
  var loginSuccessMsg = document.querySelector('.signin-account-container');
  loginSuccessMsg.textContent = '';
  loginSuccessMsg.style.display = 'flex';
  loginSuccessMsg.style.justifyContent = 'center';
  loginSuccessMsg.style.alignItems = 'center';
  ...
  loginSuccessMsg.insertAdjacentText('afterbegin', 'You were Logged in successfully');
};

exports.showMyAlert = showMyAlert;

var showMyAlertFail = function showMyAlertFail() {
  var loginErrorMsg = document.querySelector('.signin-account-container');
  ...
  loginErrorMsg.insertAdjacentText('afterbegin', 'Error logging out! Please Try again.');
};

exports.showMyAlertFail = showMyAlertFail;
...
var logoutBtn = document.getElementById('logout-clicked');
exports.logoutBtn = logoutBtn;
if (logoutBtn) logoutBtn.addEventListener('click', logout); //const logoutBtn = document.getElementById('logout-clicked');
...
var displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    ...
    scrollZoom: true //style: 'mapbox://styles/darioamade/cknoe9yo454zk17mpnj1yegjp',
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(name, email, country, home_tel, mobile_tel) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
  ...
  return function updateSettings(_x, _x2, _x3, _x4, _x5) {
    return _ref.apply(this, arguments);
  };
}();

exports.updateSettings = updateSettings;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"loadSearchResults.js":[function(require,module,exports) {
...
//     const parentEl =getQuery.value;
// };
},{}],"bookmark.js":[function(require,module,exports) {
/* export const state = {
  bookmark: [],
};
export const addBookmark = function (men) {
    state.bookmark.push(men)
    if(men.id === state.men.id) state.men.bookmark = true 
};
 */
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(menId) {
    var stripe, session;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51IWNL3JMGciq6dxqMnbSC6S7Sa15oelmIKAEPuQ3E31c7rHhpzJVSMvZsIDcFksrPb8KN3aDnYamqoe46bIlVnMW00nC7lvWaY');
            _context.prev = 1;
            _context.next = 4;
            return (0, _axios.default)("/api/v1/bookings/checkout-session/".concat(menId));
